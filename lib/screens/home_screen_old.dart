...
class DashboardScreen extends StatelessWidget {
  ...
  List<Widget> _buildCircularMenuItems(BuildContext context) {
    final menuItems = [
      ...
      {'icon': Icons.location_on, 'label': 'ŞUBELERİMİZ', 'angle': 3 * math.pi / 4},
      ...
      {'icon': Icons.campaign, 'label': 'KAMPANYALAR', 'angle': 7 * math.pi / 4},
    ];
    ...
    switch (label) {
      ...
      default:
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('$label sayfası yakında!')),
        );
    }
  }
  
  Widget _buildPromotionCard(String title, String subtitle, String value, Gradient gradient) {
    return Container(
